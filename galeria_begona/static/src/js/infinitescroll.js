    ...
    .done(function (data) {
      ...
      data.slice(0, 9).forEach(function (item) {
        $('<div class="col-sm-4 spacer"></div>')
          ...
          .append('<div class="gallery-img" data-toggle="modal" data-target="#galleryOne"><a href="#myCarousel" data-slide-to="' + currentElements + '"><img src="http://dev.com:8000/static/img/galeria/large/gallery1.jpg" class="img-responsive" alt="Gallery" /></a></div>');
